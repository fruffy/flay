#ifndef BACKENDS_P4TOOLS_MODULES_FLAY_CONTROL_PLANE_PROTOBUF_UTILS_H_
#define BACKENDS_P4TOOLS_MODULES_FLAY_CONTROL_PLANE_PROTOBUF_UTILS_H_
...
namespace P4Tools::Flay::Protobuf {
...
inline big_int stringToBigInt(const std::string &valueString) {
    big_int value;
    std::vector<uint8_t> Uint8Vec(valueString.begin(), valueString.end());
    boost::multiprecision::import_bits(value, Uint8Vec.begin(), Uint8Vec.end());
    return value;
}
...
#endif /* BACKENDS_P4TOOLS_MODULES_FLAY_CONTROL_PLANE_PROTOBUF_UTILS_H_ */
