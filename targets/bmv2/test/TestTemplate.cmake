...
function(p4tools_add_test_with_args)
  ...
  set(tag ${TOOLS_FLAY_V1MODEL_TESTS_TAG})
  set(driver ${TOOLS_FLAY_V1MODEL_TESTS_DRIVER})
  set(alias ${TOOLS_FLAY_V1MODEL_TESTS_ALIAS})
  set(p4test ${TOOLS_FLAY_V1MODEL_TESTS_P4TEST})
  set(target ${TOOLS_FLAY_V1MODEL_TESTS_TARGET})
