...
parser ParserImpl(packet_in packet, out headers_t hd, inout smartnic_metadata meta, inout standard_metadata_t smeta) {
    state start {
...
control DeparserImpl(packet_out packet, in headers_t hdr, inout smartnic_metadata meta, inout standard_metadata_t smeta) {
    apply {
...
action tunnel_decap(inout headers_t hdr, inout smartnic_metadata meta) {
...
control acl(inout headers_t hdr, inout smartnic_metadata meta) {
    action permit() {
    }
    ...
    table stage1 {
        key = {
            ...
            meta.src_l4_port             : range;
            meta.dst_l4_port             : range;
        }
        actions = {
            permit;
            permit_and_continue;
...
action push_action_static_encap(in headers_t hdr, inout smartnic_metadata meta, in dash_encapsulation_t encap=dash_encapsulation_t.VXLAN, in bit<24> vni=0, in IPv4Address underlay_sip=0, in IPv4Address underlay_dip=0, in EthernetAddress underlay_smac=0, in EthernetAddress underlay_dmac=0, in EthernetAddress overlay_dmac=0) {
...
control do_action_static_encap(inout headers_t hdr, inout smartnic_metadata meta) {
    apply {
...
action push_action_nat46(in headers_t hdr, inout smartnic_metadata meta, in IPv6Address sip, in IPv6Address sip_mask, in IPv6Address dip, in IPv6Address dip_mask) {
...
control do_action_nat46(inout headers_t hdr, in smartnic_metadata meta) {
    apply {
...
action push_action_nat64(in headers_t hdr, inout smartnic_metadata meta, in IPv4Address src, in IPv4Address dst) {
...
control do_action_nat64(inout headers_t hdr, in smartnic_metadata meta) {
    apply {
...
action set_route_meter_attrs(inout smartnic_metadata meta, bit<1> meter_policy_en, bit<16> meter_class) {
    meta.meter_policy_en = meter_policy_en;
    meta.route_meter_class = meter_class;
}
action set_mapping_meter_attr(inout smartnic_metadata meta, in bit<16> meter_class, in bit<1> meter_class_override) {
    meta.mapping_meter_class = meter_class;
    meta.mapping_meter_class_override = meter_class_override;
}
action drop(inout smartnic_metadata meta) {
    meta.target_stage = dash_pipeline_stage_t.ROUTING_ACTION_APPLY;
    meta.dropped = true;
}
action route_vnet(inout headers_t hdr, inout smartnic_metadata meta, bit<16> dst_vnet_id, bit<1> meter_policy_en, bit<16> meter_class) {
...
action route_vnet_direct(inout headers_t hdr, inout smartnic_metadata meta, bit<16> dst_vnet_id, bit<1> overlay_ip_is_v6, IPv4ORv6Address overlay_ip, bit<1> meter_policy_en, bit<16> meter_class) {
    meta.target_stage = dash_pipeline_stage_t.OUTBOUND_MAPPING;
    meta.dst_vnet_id = dst_vnet_id;
...
action route_direct(inout headers_t hdr, inout smartnic_metadata meta, bit<1> meter_policy_en, bit<16> meter_class) {
    meta.target_stage = dash_pipeline_stage_t.ROUTING_ACTION_APPLY;
    set_route_meter_attrs(meta, meter_policy_en, meter_class);
}
action route_service_tunnel(inout headers_t hdr, inout smartnic_metadata meta, bit<1> overlay_dip_is_v6, IPv4ORv6Address overlay_dip, bit<1> overlay_dip_mask_is_v6, IPv4ORv6Address overlay_dip_mask, bit<1> overlay_sip_is_v6, IPv4ORv6Address overlay_sip, bit<1> overlay_sip_mask_is_v6, IPv4ORv6Address overlay_sip_mask, bit<1> underlay_dip_is_v6, IPv4ORv6Address underlay_dip, bit<1> underlay_sip_is_v6, IPv4ORv6Address underlay_sip, dash_encapsulation_t dash_encapsulation, bit<24> tunnel_key, bit<1> meter_policy_en, bit<16> meter_class) {
    meta.target_stage = dash_pipeline_stage_t.ROUTING_ACTION_APPLY;
...
action set_tunnel_mapping(inout headers_t hdr, inout smartnic_metadata meta, IPv4Address underlay_dip, EthernetAddress overlay_dmac, bit<1> use_dst_vnet_vni, bit<16> meter_class, bit<1> meter_class_override) {
    meta.target_stage = dash_pipeline_stage_t.ROUTING_ACTION_APPLY;
...
action set_private_link_mapping(inout headers_t hdr, inout smartnic_metadata meta,IPv4Address underlay_dip, IPv6Address overlay_sip, IPv6Address overlay_dip, dash_encapsulation_t dash_encapsulation, bit<24> tunnel_key, bit<16> meter_class, bit<1> meter_class_override) {
    meta.target_stage = dash_pipeline_stage_t.ROUTING_ACTION_APPLY;
...
control outbound_routing_stage(inout headers_t hdr, inout smartnic_metadata meta) {
    table routing {
        key = {
            meta.eni_id          : exact;
...
control outbound_mapping_stage(inout headers_t hdr, inout smartnic_metadata meta) {
    table ca_to_pa {
        key = {
...
control outbound(inout headers_t hdr, inout smartnic_metadata meta) {
    apply {
...
control inbound(inout headers_t hdr, inout smartnic_metadata meta) {
    apply {
...
control direction_lookup_stage(inout headers_t hdr, inout smartnic_metadata meta) {
...
control eni_lookup_stage(inout headers_t hdr, inout smartnic_metadata meta) {
...
control routing_action_apply(inout headers_t hdr, inout smartnic_metadata meta) {
    apply {
...
control metering_update_stage(inout headers_t hdr, inout smartnic_metadata meta) {
    action check_ip_addr_family(bit<32> ip_addr_family) {
        if (ip_addr_family == 0) {
    ...
    action meter_bucket_action(bit<32> meter_bucket_index) {
    ...
    table eni_meter {
        key = {
            meta.eni_id   : exact;
            (bit<16>) meta.direction: exact @name("eni_meter_direction");
            meta.dropped  : exact;
        }
        actions = {
            NoAction;
...
control underlay(inout headers_t hdr, inout smartnic_metadata meta) {
...
control MatchActionImpl(inout headers_t hdr, inout smartnic_metadata meta, inout standard_metadata_t smeta) {
    action drop_action() {
        smeta.drop = 1;
    }
    action deny() {
...
XilinxPipeline(ParserImpl(), MatchActionImpl(), DeparserImpl()) main;
