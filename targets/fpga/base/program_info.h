#ifndef BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_FPGA_BASE_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_FPGA_BASE_PROGRAM_INFO_H_
...
class FpgaBaseProgramInfo : public ProgramInfo {
 protected:
    ...
    explicit FpgaBaseProgramInfo(const FlayCompilerResult &compilerResult,
