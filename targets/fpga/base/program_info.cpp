...
FpgaBaseProgramInfo::getProgrammableBlocks() const {
    return &programmableBlocks;
}

const IR::PathExpression *FpgaBaseProgramInfo::getBlockParam(cstring blockLabel,
...
const FlayCompilerResult &FpgaBaseProgramInfo::getCompilerResult() const {
