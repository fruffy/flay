...
control SwitchIngress(
    ...
    // Instantiate an action select with 1024 entries.
    Hash<bit<16>>(HashAlgorithm_t.CRC16) simple_hash;
    ActionSelector(action_profile=action_profile,
                   hash=simple_hash,mode = SelectorMode_t.FAIR,
                   max_group_size = 1024,
                   num_groups = 1024
    ) action_selector;
