#ifndef BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_TOFINO_BASE_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_TOFINO_BASE_PROGRAM_INFO_H_
...
class TofinoBaseProgramInfo : public ProgramInfo {
 protected:
    ...
    explicit TofinoBaseProgramInfo(const FlayCompilerResult &compilerResult,
...
#endif /* BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_TOFINO_BASE_PROGRAM_INFO_H_ */
