...
NikssBaseProgramInfo::NikssBaseProgramInfo(
...
NikssBaseProgramInfo::getProgrammableBlocks() const {
...
const FlayCompilerResult &NikssBaseProgramInfo::getCompilerResult() const {
