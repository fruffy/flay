#ifndef BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_NIKSS_SYMBOLIC_STATE_H_
#define BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_NIKSS_SYMBOLIC_STATE_H_

#include "backends/p4tools/modules/flay/core/control_plane/symbolic_state.h"

namespace P4::P4Tools::Flay::Nikss {

class NikssControlPlaneInitializer : public ControlPlaneStateInitializer {
 ...
 public:
    NikssControlPlaneInitializer() = default;
...
#endif /* BACKENDS_P4TOOLS_MODULES_FLAY_TARGETS_NIKSS_SYMBOLIC_STATE_H_ */
