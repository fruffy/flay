...
function(p4tools_add_test_with_args)
  ...
  cmake_parse_arguments(
    TOOLS_FLAY_XSA_TESTS "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN}
  )
  # Set some lowercase variables for convenience.
  set(tag ${TOOLS_FLAY_XSA_TESTS_TAG})
  set(driver ${TOOLS_FLAY_XSA_TESTS_DRIVER})
  set(alias ${TOOLS_FLAY_XSA_TESTS_ALIAS})
  set(p4test ${TOOLS_FLAY_XSA_TESTS_P4TEST})
  set(target ${TOOLS_FLAY_XSA_TESTS_TARGET})
  set(arch ${TOOLS_FLAY_XSA_TESTS_ARCH})
  set(test_args ${TOOLS_FLAY_XSA_TESTS_TEST_ARGS})
  set(cmake_args ${TOOLS_FLAY_XSA_TESTS_CMAKE_ARGS})
  set(control_plane_updates ${TOOLS_FLAY_XSA_TESTS_CONTROL_PLANE_UPDATES})
