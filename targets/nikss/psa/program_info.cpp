...
PsaProgramInfo::PsaProgramInfo(const FlayCompilerResult &compilerResult,
                               ordered_map<cstring, const IR::Type_Declaration *> inputBlocks)
    : NikssBaseProgramInfo(compilerResult, std::move(inputBlocks)) {
...
std::vector<const IR::Node *> PsaProgramInfo::processDeclaration(
